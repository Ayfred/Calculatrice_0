...
public class Input implements EventHandler<KeyEvent> {//Interface EventHandler avec comme type KeyEvent pour la gestion du clavier
    ...
    public void handle(KeyEvent keyEvent){
        ...
        GUI GUI = controleur.GUI;
        List<Button> buttons = GUI.buttons;
        ...
        if(key == KeyCode.DIGIT0 || key == KeyCode.NUMPAD0){
            ...
            GUI.updateButtonOnKey(buttons.get(0), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT1 || key == KeyCode.NUMPAD1){
            controleur.update("1");
            GUI.updateButtonOnKey(buttons.get(1), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT2 || key == KeyCode.NUMPAD2){
            controleur.update("2");
            GUI.updateButtonOnKey(buttons.get(2), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT3 || key == KeyCode.NUMPAD3){
            controleur.update("3");
            GUI.updateButtonOnKey(buttons.get(3), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT4 || key == KeyCode.NUMPAD4){
            controleur.update("4");
            GUI.updateButtonOnKey(buttons.get(4), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT5 || key == KeyCode.NUMPAD5){
            controleur.update("5");
            GUI.updateButtonOnKey(buttons.get(5), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT6 || key == KeyCode.NUMPAD6){
            controleur.update("6");
            GUI.updateButtonOnKey(buttons.get(6), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT7 || key == KeyCode.NUMPAD7){
            controleur.update("7");
            GUI.updateButtonOnKey(buttons.get(7), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT8 || key == KeyCode.NUMPAD8){
            controleur.update("8");
            GUI.updateButtonOnKey(buttons.get(8), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.DIGIT9 || key == KeyCode.NUMPAD9){
            controleur.update("9");
            GUI.updateButtonOnKey(buttons.get(9), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.ENTER ||key == KeyCode.SPACE){
            controleur.push();
            GUI.updateButtonOnKey(buttons.get(11), "-fx-background-color: #EC9706");
        }
        else if(key == KeyCode.SUBTRACT){
            controleur.operation("-");
            GUI.updateButtonOnKey(buttons.get(13), "-fx-background-color: #EC9706");
        }
        else if(key == KeyCode.ADD){
            controleur.operation("+");
            GUI.updateButtonOnKey(buttons.get(12), "-fx-background-color: #EC9706");
        }
        else if(key == KeyCode.DIVIDE){
            controleur.operation("/");
            GUI.updateButtonOnKey(buttons.get(15), "-fx-background-color: #EC9706");
        }
        else if(key == KeyCode.ASTERISK || key == KeyCode.MULTIPLY){
            controleur.operation("x");
            GUI.updateButtonOnKey(buttons.get(14), "-fx-background-color: #EC9706");
        }
        else if(key == KeyCode.C){
            controleur.accumulateur.clear();
            GUI.updateButtonOnKey(buttons.get(10), "-fx-background-color: #bcbcbc");
        }
        else if(key == KeyCode.DECIMAL){
            controleur.virgule();
            GUI.updateButtonOnKey(buttons.get(17), "-fx-background-color: #5A5A5A");
        }
        else if(key == KeyCode.N){
            controleur.negatif();
            GUI.updateButtonOnKey(buttons.get(16), "-fx-background-color: #bcbcbc");
        }
        else if(key == KeyCode.UNDEFINED){//touche % ou ù
            controleur.pourcentage();
            GUI.updateButtonOnKey(buttons.get(18), "-fx-background-color: #bcbcbc");
        }
        else if(key == KeyCode.BACK_SPACE){
            controleur.supprimer();
            GUI.updateButtonOnKey(buttons.get(19), "-fx-background-color: #5A5A5A");
        }
